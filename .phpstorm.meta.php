...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/sicheltechnology/Documents/Web Apps/developer-portfolio/portfolio/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/sicheltechnology/Documents/Web Apps/developer-portfolio/portfolio/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'social.github','social.linkedin','social.twitter','social.instagram','social.whatsapp',
'social.youtube','social.threads','social.facebook','hashing.driver','hashing.bcrypt.rounds',
...
'dompdf.options.enable_html5_parser','telescope.enabled','telescope.domain','telescope.path','telescope.driver',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','excel.exports.chunk_size','excel.exports.pre_calculate_formulas',
...
'excel.temporary_files.local_permissions','excel.temporary_files.remote_disk','excel.temporary_files.remote_prefix','excel.temporary_files.force_resync_remote','activitylog.enabled',
...
'activitylog.table_name','activitylog.database_connection','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'telescope','home','about','portfolio',
'resume','contact','welcome','contact.store',
'newsletter.subscribe','newsletter.confirm','newsletter.unsubscribe','dashboard','dashboard.activity',
'api.docs','clients.index','clients.create','clients.store','clients.show',
'clients.edit','clients.update','clients.destroy','clients.communications.index','clients.communications.create',
'clients.communications.store','clients.communications.show','clients.communications.edit','clients.communications.update','clients.communications.destroy',
'sales.deals.index','sales.deals.create','sales.deals.store','sales.deals.show','sales.deals.edit',
'sales.deals.update','sales.deals.destroy','sales.deals.update-stage','sales.deals.board','sales.deals.board.update-stage',
'sales.leads.index','sales.leads.create','sales.leads.store','sales.leads.show','sales.leads.edit',
'sales.leads.update','sales.leads.destroy','sales.products.index','sales.products.create','sales.products.store',
'sales.products.show','sales.products.edit','sales.products.update','sales.products.destroy','sales.quotes.index',
'sales.quotes.create','sales.quotes.store','sales.quotes.show','sales.quotes.edit','sales.quotes.update',
'sales.quotes.destroy','sales.forecast','sales.forecast.report','sales.test','sales.calendar',
'sales.calendar.events.store','sales.calendar.events.update','sales.calendar.events.destroy','projects.index','projects.create',
'projects.store','projects.show','projects.edit','projects.update','projects.destroy',
'tasks.index','tasks.create','tasks.store','tasks.show','tasks.edit',
'tasks.update','tasks.destroy','projects.tasks.update-status','projects.time.index','projects.time.create',
'projects.time.store','projects.time.edit','projects.time.update','projects.time.destroy','projects.time.start',
'projects.time.stop','projects.tasks.list','campaigns.index','campaigns.create','campaigns.store',
'campaigns.show','campaigns.edit','campaigns.update','campaigns.destroy','marketing.analytics',
'marketing.website-contacts.index','marketing.website-contacts.show','marketing.website-contacts.update-status','marketing.website-contacts.assign','marketing.website-contacts.convert',
'marketing.website-contacts.destroy','marketing.subscribers.index','marketing.subscribers.create','marketing.subscribers.store','marketing.subscribers.confirm',
'marketing.subscribers.destroy','marketing.subscribers.import','marketing.subscribers.export','settings.team','team.invite',
'team.update-role','team.destroy','settings.api-tokens','settings.api-tokens.store','settings.api-tokens.destroy','profile.edit','profile.update','profile.destroy','password.edit',
...
'GITHUB_URL','LINKEDIN_URL','TWITTER_URL','INSTAGRAM_URL','WHATSAPP_URL',
'YOUTUBE_URL','THREADS_URL','FACEBOOK_URL',);
