...
export function TableHeadCell({ children, className = '', align = 'left' }) {
  ...
  return (
    <th
      scope="col"
      className={`px-4 py-4 ${alignmentClass} text-xs font-medium text-muted-foreground uppercase tracking-wider ${className}`}
    >
      {children}
    </th>
  );
...
export function TableCell({ children, className = '', align = 'left' }) {
  ...
  return (
    <td className={`px-4 py-4 whitespace-nowrap text-sm text-foreground ${alignmentClass} ${className}`}>
      {children}
    </td>
  );
}
...
export function SortableTableHeadCell({
  ...
  return (
    <th
      scope="col"
      className={`px-4 py-4 ${alignmentClass} text-xs font-medium text-muted-foreground uppercase tracking-wider cursor-pointer hover:text-foreground ${className}`}
