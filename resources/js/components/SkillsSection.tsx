...
export default function SkillsSection() {
    ...
    return (
        <section id="skills" className="bg-gradient-to-b from-gray-50/80 to-white/90 dark:from-gray-900/80 dark:to-gray-800/90 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className={`transition-all duration-1000 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <SectionHeading
                        ...
                        subtitle="My comprehensive technical skills and areas of expertise across frontend, backend, AI/ML, mobile, and DevOps technologies. I'm constantly expanding my knowledge to stay at the cutting edge of modern development."
                ...
                <div className={`mt-20 relative transition-all duration-1000 delay-800 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/80 dark:border-gray-700/80 shadow-lg text-center group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            <div className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-600 to-blue-600 dark:from-cyan-400 dark:to-blue-400 mb-2 group-hover:scale-110 transition-transform duration-300">0+</div>
                            <div className="text-gray-600 dark:text-gray-400">Years Experience</div>
                        </div>
                        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/80 dark:border-gray-700/80 shadow-lg text-center group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            <div className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-400 dark:to-indigo-400 mb-2 group-hover:scale-110 transition-transform duration-300">88+</div>
