...
export default function ApiDocs() {
  return (
    <AppLayout breadcrumbs={[{ label: 'API Documentation', href: '/api-docs' }]}>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="text-md font-medium text-gray-900">Unsubscribe (Public)</h4>
                  <p className="mt-1 text-sm text-gray-500">DELETE /api/newsletter/unsubscribe/{'{id}'}</p>
                </div>
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">Optional query parameters: confirmed, date_from, date_to, search, sort_by, sort_direction, per_page</p>
                </div>
                <div>
