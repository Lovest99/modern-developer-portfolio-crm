...
export default function Products({ products, categories, filters }) {
  ...
  const handleSort = (field) => {
    ...
    window.location.href = route('sales.products.index', {
      search: searchQuery,
      category: selectedCategory,
      sort_field: field,
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHeadCell className="w-[150px]" align="center">
                        <button
                      ...
                      <TableHeadCell className="w-[100px]" align="right">Actions</TableHeadCell>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
